...
Module {
    ...
    property stringList config: ["shared","shared","release","no_plugin_manifest"]
    property stringList qtConfig: ["shared","shared","debug_and_release","debug","release","build_all","c++11","concurrent","dbus","no-pkg-config","stl"]
    property path binPath: "C:/Qt/5.14.2/msvc2015_64/bin"
    property path installPath: "C:/Qt/5.14.2/msvc2015_64/bin"
    property path incPath: "C:/Qt/5.14.2/msvc2015_64/include"
    property path libPath: "C:/Qt/5.14.2/msvc2015_64/lib"
    property path libExecPath: undefined
    property path qmlLibExecPath: "C:/Qt/5.14.2/msvc2015_64/bin"
    property path pluginPath: "C:/Qt/5.14.2/msvc2015_64/plugins"
    property string mkspecName: "win32-msvc"
    property path mkspecPath: "C:/Qt/5.14.2/msvc2015_64/mkspecs/win32-msvc"
    ...
    property path docPath: "C:/Qt/Docs/Qt-5.14.2"
    ...
    property string libFilePathDebug: "C:/Qt/5.14.2/msvc2015_64/lib/Qt5Cored.lib"
    property string libFilePathRelease: "C:/Qt/5.14.2/msvc2015_64/lib/Qt5Core.lib"
    ...
    property stringList moduleConfig: ["lex","yacc","exceptions","depend_includepath","testcase_targets","import_plugins","import_qpa_plugin","windows","prepare_docs","qt_docs_targets","qt_build_extra","file_copies","qmake_use","qt","warn_on","release","link_prl","flat","debug_and_release","precompile_header","autogen_precompile_source","embed_manifest_dll","embed_manifest_exe","shared","shared","release","no_plugin_manifest","win32","msvc","copy_dir_files","sse2","aesni","sse3","ssse3","sse4_1","sse4_2","avx","avx2","compile_examples","f16c","force_debug_info","largefile","precompile_header","rdrnd","shani","x86SimdAlways","prefix_build","force_independent","utf8_source","create_prl","link_prl","no_private_qt_headers_warning","QTDIR_build","qt_example_installs","testcase_exceptions","warning_clean","release","ReleaseBuild","Release","build_pass","c++11","win32-msvc2015","exceptions","qt_tracepoints","moc","resources","simd","optimize_full","no_core_dep","pcre2","generated_privates","relative_qt_rpath","git_build","target_qt","c++11","strict_c++","qt_install_headers","need_fwd_pri","qt_install_module","debug_and_release","build_all","create_cmake","skip_target_version_ext","release","ReleaseBuild","Release","build_pass","have_target","dll","exclusive_builds","debug_info","no_autoqmake","arch_haswell","thread"]
    Properties {
    ...
    cpp.systemIncludePaths: ["C:/Qt/5.14.2/msvc2015_64/include","C:/Qt/5.14.2/msvc2015_64/include/QtCore"].concat(mkspecPath)
    cpp.libraryPaths: {
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? ["Shell32.lib","C:/Qt/5.14.2/msvc2015_64/lib/qtmaind.lib"] : ["Shell32.lib","C:/Qt/5.14.2/msvc2015_64/lib/qtmain.lib"]);
        }
