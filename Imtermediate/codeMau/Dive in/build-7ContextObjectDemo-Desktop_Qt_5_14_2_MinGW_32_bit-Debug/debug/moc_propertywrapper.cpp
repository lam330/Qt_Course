...
#include <memory>
#include "../../7ContextObjectDemo/propertywrapper.h"
...
QT_MOC_LITERAL(1, 16, 15), // "lastnameChanged"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 8), // "lastname"
QT_MOC_LITERAL(4, 42, 16), // "firstnameChanged"
QT_MOC_LITERAL(5, 59, 9) // "firstname"

    },
    "PropertyWrapper\0lastnameChanged\0\0"
    "lastname\0firstnameChanged\0firstname"
};
...
void PropertyWrapper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->lastnameChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PropertyWrapper::lastnameChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->lastname(); break;
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setLastname(*reinterpret_cast< QString*>(_v)); break;
...
// SIGNAL 0
void PropertyWrapper::lastnameChanged(QString _t1)
{
